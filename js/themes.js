// Each theme: array of 8-line messages (GRID_ROWS=8, GRID_COLS=16)
...
export const THEMES = {
  ...
  philosophy: {
    ...
    messages: [
      ...
      ['', 'WASTE NO MORE', 'TIME ARGUING', 'WHAT A GOOD', 'MAN IS .', 'BE ONE .', '', '- AURELIUS'],
      ['', 'WE SUFFER', 'MORE OFTEN IN', 'IMAGINATION', 'THAN IN', 'REALITY', '', '- SENECA'],
      ['', 'EVERYBODY', 'HAS A PLAN', 'UNTIL THEY', 'GET PUNCHED', 'IN THE MOUTH', '', '- MIKE TYSON'],
      ['', 'NO MAN IS', 'FREE WHO IS', 'NOT MASTER', 'OF HIMSELF', '', '- EPICTETUS', ''],
      ['', 'COMPARISON IS', 'THE THIEF', 'OF JOY', '', '- TEDDY', 'ROOSEVELT', ''],
      ['', 'CHOOSE NOT TO', 'BE HARMED', 'AND YOU WONT', 'FEEL HARMED', '', '- AURELIUS', ''],
  ...
  comedy: {
    ...
    messages: [
      ...
      ['', 'IN TERMS OF', 'INSTANT', 'GRATIFICATION', 'CRACK COCAINE', 'IS PRETTY', 'GOOD', '- NORM MACDONALD'],
      ['', 'INSIDE EVERY', 'CYNICAL', 'PERSON THERE', 'IS A', 'DISAPPOINTED', 'IDEALIST', '- GEORGE CARLIN'],
      ['', 'THINK OF HOW', 'STUPID THE', 'AVERAGE', 'PERSON IS', 'HALF ARE', 'DUMBER', '- GEORGE CARLIN'],
  ...
  music: {
    ...
    messages: [
      ...
      ['', 'CASH RULES', 'EVERYTHING', 'AROUND ME', 'DOLLA DOLLA', 'BILL YALL', '', '- WU TANG CLAN'],
