...
- **Command**: Which command to use (prefer: /delight, /animate, /extract, /bolder, /polish, /audit, /critique, /arrange, /colorize, /adapt, /quieter, /clarify, /distill, /overdrive, /harden, /normalize, /typeset, /onboard, /optimize — or other installed skills you're sure exist)
